 ...
 * E06_BCU.c
 *
 * automatically generated from E06_BCU.cid
 */
#include "E006_BCU.h"
...
/* --- GSEControlBlock for E06BCU (gcbE06BCU) --- */
static PhyComAddress model_E06_BCU_E06BCU_LLN0_gse0_address = {
  4,
  0x000,
  4097,
  {0x01, 0x0C, 0xCD, 0x01, 0x01, 0x06}
};

GSEControlBlock model_E06_BCU_E06BCU_LLN0_gse0 = {
  &model_E06_BCU_E06BCU_LLN0,
  "gcbE06BCU",
  "gcbE06BCU",
  "SwitchStatus",
  1,
  false,
  &model_E06_BCU_E06BCU_LLN0_gse0_address,
  1,
  1000,
  NULL
};
...
model_E06_BCU_E06BCU_LLN0_NamPlt_vendor.mmsValue = MmsValue_newVisibleString("ANTAM_SIM");
...
model_E06_BCU_E06BCU_CSWI1_Pos_ctlModel.mmsValue = MmsValue_newIntegerFromInt32(1);

model_E06_BCU_E06BCU_XSWI1_Pos_ctlModel.mmsValue = MmsValue_newIntegerFromInt32(1);
